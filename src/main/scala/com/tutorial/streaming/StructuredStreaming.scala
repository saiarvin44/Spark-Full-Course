package com.tutorial.sparkstreaming

import java.text.SimpleDateFormat
import java.util.Locale
import java.util.regex.{Matcher, Pattern}

import com.tutorial.streaming.Utilities.{apacheLogPattern, setupLogging}
...
object StructuredStreaming {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession
      ...
      .master("local[*]")
      .config("spark.sql.streaming.checkpointLocation", "/Users/saibalaj/PERSONAL/hadoop/Spark with Scala/Checkpoint")
      .getOrCreate()
